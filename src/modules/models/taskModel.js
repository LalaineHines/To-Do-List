...
// eslint-disable no-pram-reassign
...
export function updateTaskDetails(task) {
    ...
    const titleInput = formContainer.querySelector('.task-title-container');
    const notesInput = formContainer.querySelector('.task-note-input');
    ...
    const listSelect = formContainer.querySelector('.task-list-selector');
